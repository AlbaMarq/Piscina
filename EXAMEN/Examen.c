...
linea. Si el numero de argumentor no es 1, o no hay argumentos, imprime un salto de linea. */
...
nuero de argumentos es distinto que 1 o no es un palindromo, muestra un salto de linea. */
